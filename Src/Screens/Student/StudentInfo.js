...
const StudentDetailsForm = ({navigation}) => {
    const Data = [
        {
          id: 4,
          name: 'Ahmed',
...
const RenderItem=({item})=>{
    return(
        ...
        <Text style={styles.textStyle}>{item.Courses.Physics}</Text>
        <Text style={styles.textStyle}>{item.Courses.Chem}</Text>
        <Text style={styles.textStyle}>{item.Courses.Bio}</Text>
        <Text style={styles.textStyle}>{item.Courses.Arts}</Text>
...
<Text style={styles.titleText}>My BioData</Text>
<FlatList
data={Data}
